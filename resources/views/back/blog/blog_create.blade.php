                ...
                <div class="card">
                    <div class="body">
                        ...
                        <div class="form-group">
                            <input value="{{ old('title') ? old('title') : '' }}" type="text" name="title" id="title" class="form-control Select2" placeholder="Title Here" />
                            <span class="text-danger">{{ $errors->first('title') }}</span>
                        </div>

                        <label for="name">Description</label>
                        <div class="form-group">
                            <textarea type="text" name="description" id="description" class="form-control" placeholder="Description Here">{{ old('description') ? old('description') : '' }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="border py-1" style="border-radius: 5px;">
                                <input value="{{ old('tags') }}" type="text" name="tags" class="form-control" data-role="tagsinput" placeholder="Tags Here" />
                            </div>
                        ...
                        <div class="form-group">
                            <input value="{{ old('image') ? old('image') : '' }}" type="file" name="image" id="image" class="form-control" />
                            <span class="text-danger">{{ $errors->first('image') }}</span>
                        </div>

                        <label for="name">Image_alt (Optional)</label>
                        <div class="form-group">
                            <input value="{{ old('image_alt') ? old('image_alt') : '' }}" type="text" name="image_alt" id="image_alt" class="form-control Select2" placeholder="Image_alt Here" />
                            <span class="text-danger">{{ $errors->first('image_alt') }}</span>
                        </div>

                        <label for="details">Details</label>
                        <div class="form-group">
                            <textarea type="text" name="details" id="details" class="form-control summernote" placeholder="Details Here">{{ old('details') ? old('details') : '' }}</textarea>
                        ...
                        <div class="form-group">
                            <select name="status" class="form-control show-tick">
                                ...
                                <option {{ old('status') == $status_msg ? 'selected' : '' }} value="{{ $status_msg }}">{{ $status_msg }}</option>
                                @endforeach
                        ...
                        <div class="mt-3 panel-group" id="collapse_one" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-primary">
                                ...
                                <div id="seo_collapse_one" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_1">
                                    ...
                                    <div class="form-group">
                                        <textarea type="text" name="keyword" id="keyword" class="form-control" placeholder="keyword Here">{{ old('keyword') ? old('keyword') : '' }}</textarea>
                                        <span class="text-danger">{{ $errors->first('keyword') }}</span>
                                    </div>
                                    <label for="name">Head script</label>
                                    <div class="form-group">
                                        <textarea type="text" name="head_script" id="head_script" class="form-control" placeholder="Head script Here">{{ old('head_script') ? old('head_script') : '' }}</textarea>
                                        <span class="text-danger">{{ $errors->first('head_script') }}</span>
                                    </div>
                                    <label for="name">Body Script</label>
                                    <div class="form-group">
                                        <textarea type="text" name="body_script" id="body_script" class="form-control" placeholder="Body Script Here">{{ old('body_script') ? old('body_script') : '' }}</textarea>
                        ...
                        <div class="mt-2 panel-group" id="collapse_two" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-primary">
                                ...
                                <div id="custom_collapse" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_1">
                                    ...
                                    <div class="form-group">
                                        <textarea type="text" name="custom_html" id="custom_html" class="form-control" placeholder="Custom html Here">{{ old('custom_html') ? old('custom_html') : '' }}</textarea>
                                        <span class="text-danger">{{ $errors->first('custom_html') }}</span>
                                    </div>
                                    <label for="name">Custom css</label>
                                    <div class="form-group">
                                        <textarea type="text" name="custom_css" id="custom_css" class="form-control" placeholder="Custom css Here">{{ old('custom_css') ? old('custom_css') : '' }}</textarea>
                                        <span class="text-danger">{{ $errors->first('custom_css') }}</span>
                                    </div>
                                    <label for="name">Custom js</label>
                                    <div class="form-group">
                                        <textarea type="text" name="custom_js" id="custom_js" class="form-control" placeholder="Custom js Here">{{ old('custom_js') ? old('custom_js') : '' }}</textarea>
