                        ...
                        <table class="table m-b-0">
                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <td>
                                    <img style="width: 44px; display: block; margin: 0 auto; margin-top: -7px; border-radius: 50%" src="{{ $user->image ? asset($user->image) : Avatar::create( $user->name ) }}" alt="image"> 
                                    {{-- style="width: 44px; display: block; margin: 0 auto; margin-top: -7px; border-radius: 50%" --}}
                                ...
                                <td>
                                    <div class="btn-area">
                                        <a href="{{ route('users.edit', $user) }}" type="submit" class="btn btn-raised btn-primary btn-round waves-effect">Edit</a>
