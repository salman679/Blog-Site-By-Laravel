            ...
            <div class="card">
                <div class="body">
                    <form method="POST" action="{{ route('users.update', $users) }}" enctype="multipart/form-data">
                        <label for="name">User Information Edit</label>
                        @csrf
                        @method('PUT')
                        <div class="form-group">                                
                            <input value="{{ $users->name }}" type="text" name="name" id="name" class="form-control" placeholder="Your Name Here">
                            <span class="text-danger">{{ $errors->first('name') }}</span>
                        </div>
                        <div class="form-group">                                
                            <input value="{{ $users->email }}" readonly type="email" name="email" id="email" class="form-control" placeholder="Your Email Here">
                        ...
                        <div class="form-group">                                
                            <input data-default-file="{{ asset($users->image) }}" type="file" name="image" id="image" class="form-control">
